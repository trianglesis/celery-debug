...
try:
    ...
    octolog.error("<=DJ Celery Managers=> from celery.utils.time import maybe_timedelta")
except ImportError:  # pragma: no cover
    from celery.utils.timeutils import maybe_timedelta  # noqa
    octolog.error("<=DJ Celery Managers=> from celery.utils.timeutils import maybe_timedelta")
...
class TaskResultManager(models.Manager):
    ...
    def store_result(self, content_type, content_encoding,
        ...
        octolog.error("<=DJ Celery Managers=> Save to DB: fields: %s", fields)
